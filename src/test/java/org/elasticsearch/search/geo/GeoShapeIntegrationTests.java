...
public class GeoShapeIntegrationTests extends ElasticsearchIntegrationTest {
    ...
    @Test
    /** Same as testParsingMultipleShapes(), but with mandatory routing enabled. See #7663. */
    public void testParsingMultipleShapesWithRouting() throws Exception {
        String mapping = XContentFactory.jsonBuilder()
                .startObject()
                .startObject("type1")
                .startObject("_routing")
                .field("required", true)
                .field("path", "routing_key")
                .endObject()
                .startObject("properties")
                .startObject("location1")
                .field("type", "geo_shape")
